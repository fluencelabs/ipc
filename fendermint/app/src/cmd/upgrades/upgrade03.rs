...
static FLUENCE_BATCHED_WASM_BIN: &[u8] = include_bytes!(".../upgrade03/fendermint_actor_fluence_batched.wasm");
...
pub fn upgrade_wasm_actor_func(
    ...
    let new_empty_state = state_tree.store().put_cbor(
        &EMPTY_ARR,
        Code::Blake2b256
    )?;
